...
public class OdometryGlobalCoordinatePosition implements Runnable{
     ...
     * @param horizontalEncoder backOdometer odometry encoder, perpendicular to the other two odometry encoder wheels
    ...
    {
        return -1 * (Math.toDegrees(robotOrientationRadians) % 360);
    }
